  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetContent>
        ...
        <form onSubmit={handleSubmit} className=" mt-5 grid flex-1 auto-rows-min gap-6 px-4">
          <div className="grid gap-3">
            <Label htmlFor="empId">Employee ID</Label>
            <Input id="empId" name="empId" value={formData.empId} onChange={handleChange} disabled />
          </div>
          <div className="grid gap-3">
